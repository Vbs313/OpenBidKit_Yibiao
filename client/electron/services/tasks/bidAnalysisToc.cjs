...
const TASK_TOC_KEYWORDS = {
  projectOverview: ['项目概述', '项目简介', '项目背景', '工程概况', '采购项目', '项目名称', '总则', '概述', '项目概况', '招标公告', '竞争性谈判公告', '竞争性磋商公告', '采购公告'],
  techRequirements: ['技术评分', '评标办法', '评审办法', '评分标准', '技术要求', '技术规格', '技术参数', '评审因素', '评审内容', '技术部分', '技术方案评分', '详细评审', '采购内容', '总体要求', '实施集成', '技术规格、参', '磋商内容', '综合评分', '评分因素', '前附表'],
  projectInfo: ['项目概况', '招标公告', '项目名称', '项目编号', '招标编号', '采购项目', '项目基本情况', '竞争性谈判公告', '竞争性磋商公告', '采购公告'],
  partAInfo: ['招标人', '采购人', '联系方式', '联系方式及', '采购单位'],
  ...
  responseFileRequirements: ['投标文件', '响应文件', '文件编制', '投标文件编制', '格式', '签章', '密封', '递交', '响应文件格式', '谈判响应文件', '磋商响应文件'],
  agentInfo: ['代理机构', '采购代理', '招标代理'],
  keyInfo: ['招标公告', '投标截止', '开标时间', '获取招标文件', '投标须知前附表', '谈判须知', '磋商须知', '提交响应文件', '竞争性谈判公告', '竞争性磋商公告'],
  marginInfo: ['保证金', '投标保证金', '履约保证金'],
  qualificationReview: ['资格性审查', '投标人资格', '资格条件', '资格审查', '资格要求', '申请人的资格', '供应商资格'],
  complianceCheck: ['符合性', '响应性审查', '无效投标', '废标', '否决投标', '无效响应'],
  openBid: ['开标', '开标仪式', '开标地点', '开标程序', '谈判', '磋商', '响应文件递交'],
  evaluationBid: ['评标', '评标办法', '评标委员会', '评标程序', '谈判小组', '磋商小组', '谈判办法', '磋商办法', '评审', '谈判须知', '磋商须知', '综合评分法', '评审办法'],
  businessScoring: ['商务评分', '商务部分', '价格分', '报价评分', '商务评审', '最后报价', '谈判报价', '磋商报价'],
  discardedBids: ['无效投标', '废标', '否决投标', '废标条款', '否决', '无效标', '无效响应'],
  signingProcess: ['合同授予', '中标', '合同签订', '履约', '合同主要条款', '成交通知', '采购合同', '成交供应商'],
