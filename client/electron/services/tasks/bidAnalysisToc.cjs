...
const TASK_TOC_KEYWORDS = {
  ...
  techRequirements: ['技术评分', '评标办法', '评分标准', '技术要求', '技术规格', '技术参数', '评审因素', '评审内容', '技术部分', '技术方案评分', '详细评审', '采购内容', '总体要求', '实施集成', '技术规格、参', '磋商内容'],
  ...
  evaluationBid: ['评标', '评标办法', '评标委员会', '评标程序', '谈判小组', '磋商小组', '谈判办法', '磋商办法', '评审', '谈判须知', '磋商须知'],
