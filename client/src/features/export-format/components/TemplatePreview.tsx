// 导出格式模板预览组件。
//
// 原先它和 ExportFormatPage 同处一个文件，导致别的 feature 的首页要「import 页面模块」才能拿到预览组件，
// 形成 features/feasibility-report 与 features/technical-plan 对 features/export-format/pages 的跨层引用。
// 抽到 components/ 后：页面与其它 feature 一律从组件层引用，页面不再被跨 feature 复用。

import { useEffect, useMemo, useRef, useState, type CSSProperties, type ReactNode } from 'react';
import type { ExportFormatConfig, PaperSize } from '../../../shared/types/exportFormat';
import { PAPER_DIMENSIONS } from '../../../shared/types/exportFormat';
